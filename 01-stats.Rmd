...
Ils permettent de décider, avec un seuil d'erreur $\alpha$ spécifié, si les écarts présentés par l'échantillon par rapport aux valeurs théoriques attendues sont dûs au hasard ou sont au contraire significatifs.
...
Il existe un package permettant d'entrainer une donnée selon la loi loi géométrique du nom de fitdistrplus[^1].
...
Comme nous l'avons fait précédemment, nous allons chercher le meilleur paramétré $\mu log$ et $sdlog$ pour la charge des sinistres qui suivrait une loi lognormale.
